create_records([
  {name: 'HELLO', description: 'THIS IS NOT AN IMPRINTABLE', 
    quantity: 1, unit_price: 2.20, line_itemable_id: 1, line_itemable_type: 'Job'},
  ...
  {name: "Can't wait", description: "To start on imprints",
    quantity: 3, unit_price: 12, taxable: true, line_itemable_id: 3, line_itemable_type: 'Job'},
  {name: 'What up', description: 'in this',
    quantity: 2, unit_price: 1, taxable: true, line_itemable_id: 3, line_itemable_type: 'Job'},
  ...
  {name: "Unfortunate", description: "I don't really know what kind of stuff
    ...
    quantity: 1, unit_price: 100, line_itemable_id: 4, line_itemable_type: 'Job'},
  {name: "Blah blah", description: "Need more content!",
    quantity: 12, unit_price: 0.1, taxable: true, line_itemable_id: 4, line_itemable_type: 'Job'},
