...
feature 'Quotes management', slow: true, quote_spec: true do
  context 'As as logged in user' do
    ...
    context 'without an insightly api key' do
      ...
      scenario 'I create a quote with new contact information', edit: true, js: true, current: true do
      ...
      scenario 'I can create a quote using an existing contact', edit: true, js: true do
        visit root_path
        unhide_dashboard
